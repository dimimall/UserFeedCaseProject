...
class LoadFeedFromCacheUseCaseTests: XCTestCase {
    ...
    func test_load_requestsFeedFromCache() {
    ...
    func test_load_failsOnRetriavlaError() {
        let (sut, store) = makeSUT()
    ...
    private func expect(_ sut: LocalUserLoader, toCompleteWith expectedResult: LocalUserLoader.LoadResult, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
