...
class ValidateFeedCacheUseCaseTests: XCTestCase {
    ...
    func test_validateCache_deletesCacheOnRetrievalError() {
        ...
        XCTAssertEqual(store.receivedMessages, [.retrieve, .deleteCachedUser])
    }
    ...
    private func expect(_ sut: LocalUserLoader, toCompleteWith expectedResult: LocalUserLoader.ValidationResult, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
